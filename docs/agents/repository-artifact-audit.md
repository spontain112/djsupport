...
| 4. Canonical documentation/configuration | `.gitignore`, `.env.example`, `AGENTS.md`, `CONTEXT.md`, `agent.md`, `CLAUDE.md`, `.claude/docs/architectural_patterns.md`, `docs/adr/0001-keep-user-data-out-of-the-repository.md`, `docs/agents/domain.md`, `issue-tracker.md`, `triage-labels.md`, `legacy-document-triage.md`, this audit, and the proposed playlist-management roadmap under `docs/plans/` |

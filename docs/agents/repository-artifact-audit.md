...
| 4. Canonical documentation/configuration | `.gitignore`, `.env.example`, `AGENTS.md`, `CONTEXT.md`, `CONTRIBUTING.md`, `CLAUDE.md`, `.claude/docs/architectural_patterns.md`, `docs/adr/0001-keep-user-data-out-of-the-repository.md`, `docs/agents/domain.md`, `issue-tracker.md`, `triage-labels.md`, `legacy-document-triage.md`, this audit, and the proposed playlist-management roadmap under `docs/plans/` |
| 5. Historical but intentionally retained | Other core completed/converted plans under `docs/plans/`; `docs/research/2026-08-01-playlist-management-api-review.md`; resolved knowledge under `docs/solutions/` (all files); completed review records `todos/001` through `todos/007` |
